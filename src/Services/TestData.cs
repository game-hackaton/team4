...
public class TestData
{
    public static GameDto AGameDto(VectorDto movingObjectPosition)
    {
        var width = 10;
        var height = 8;
        var testCells = new CellDto[10 * 10];
        // {
        ...
        // new CellDto("100", new VectorDto {X = 2, Y = 4}, "color1", "", 0),
        // new CellDto("200", new VectorDto {X = 5, Y = 4}, "color1", "", 0),
        // new CellDto("300", new VectorDto {X = 3, Y = 1}, "color2", "", 20),
        // new CellDto("400", new VectorDto {X = 1, Y = 1}, "color2", "", 20),
